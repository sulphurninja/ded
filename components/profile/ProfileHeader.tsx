...
const style = {
  ...
  profileImageContainer: `w-full h-[6rem] rounded-full object-contain mt-[-3rem] mb-2 flex justify-start items-center px-3 flex justify-between`,
  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.profileImageContainer}>
        <div
          className={
            currentUser.isProfileImageNft ? 'hex' : 'hex object-contain'
          }
        >
          <img
